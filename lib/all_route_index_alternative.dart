            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: OutlineButton(
                    child: Image(
                      image: new AssetImage(_setImage("kmb")),
                      height: 50,
                    ),
                    shape: CircleBorder(),
                    onPressed: () {
                      if (buttonEnabled) {
                        setState(() {
                          ...
                          _routesForDisplay = _routesPrev.where((note) {
                            var busOperator = note.operatorHK.toLowerCase();
                            return busOperator.contains("kmb");
                          }).toList();
                        });
                      } else {
                        return null;
                ...
                Container(
                  ...
                  child: OutlineButton(
                    shape: CircleBorder(),
                    child: Image(
                      image: new AssetImage(_setImage("ctb")),
                      height: 25,
                    ),
                    onPressed: () {
                      if (buttonEnabled) {
                        setState(() {
                          ...
                          _routesForDisplay = _routesPrev.where((note) {
                            var busOperator = note.operatorHK.toLowerCase();
                            return busOperator.contains("ctb");
                          }).toList();
                        });
                      } else {
                        return null;
                ...
                Container(
                  ...
                  child: OutlineButton(
                    child: Image(
                      image: new AssetImage(_setImage("nwfb")),
                      height: 25,
                    ),
                    shape: CircleBorder(),
                    onPressed: () {
                      if (buttonEnabled) {
                        setState(() {
                          ...
                          _routesForDisplay = _routesPrev.where((note) {
                            var busOperator = note.operatorHK.toLowerCase();
                            return busOperator.contains("nwfb");
                          }).toList();
                        });
                      } else {
                        return null;
                ...
                Container(
                  ...
                  child: OutlineButton(
                    child: Image(
                      image: new AssetImage(_setImage("lwb")),
                      height: 25,
                    ),
                    shape: CircleBorder(),
                    onPressed: () {
                      if (buttonEnabled) {
                        setState(() {
                          ...
                          _routesForDisplay = _routesPrev.where((note) {
                            var busOperator = note.operatorHK.toLowerCase();
                            return busOperator.contains("lwb");
                          }).toList();
                        });
                      } else {
                        return null;
