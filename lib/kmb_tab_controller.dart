  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
          ...
          backgroundColor: getColor(widget.islwb),
          title: new Text(widget.route +
              " " +
              widget.oriTC +
              _returnSymbol(widget.isCircular) +
              widget.destTC),
          bottom: TabBar(
        ...
        body: new TabBarView(
          ...
          children: <Widget>[
            ...
            new fourth.KMBAnnouncement(
                route: widget.route, bound: widget.bound),
          ],
        ));
  }
}
